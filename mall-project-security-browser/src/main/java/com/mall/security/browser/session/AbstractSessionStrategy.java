...
public class AbstractSessionStrategy {
	...
	protected void onSessionInvalid(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (StringUtils.contains(sourceUrl,"/frontend")) {
//			if(StringUtils.equals(sourceUrl, securityPropertie.getBrowser().getLoginUrl())
//					|| StringUtils.equals(sourceUrl, securityPropertie.getBrowser().getSignUpUrl())){
//				targetUrl = sourceUrl;
//			}else{
...
//			redirectStrategy.sendRedirect(request, response, targetUrl);
			redirectStrategy.sendRedirect(request, response, securityPropertie.getBrowser().getLoginUrl());
		} else {
	...
	protected Object buildResponseContent(HttpServletRequest request) {
		...
		return new SimpleResponse(message,HttpStatus.UNAUTHORIZED.value());
	}
