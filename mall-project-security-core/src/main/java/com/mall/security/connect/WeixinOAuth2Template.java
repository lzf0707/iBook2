...
public class WeixinOAuth2Template extends OAuth2Template{
	...
	public WeixinOAuth2Template(String appId, String appSecret, String authorizeUrl, String accessTokenUrl) {
	...
	//由于换取微信token使用的参数为appId、secret，与OAuth 所用的参数 clientId、clientSecret不同，故需要重写以下方法
	@Override
